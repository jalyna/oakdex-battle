...
valid_actions = battle.valid_actions_for(trainer1) # => [{:action=>"move", :pokemon=>"0c7f2ef3-8e55-4695-b38e-a06d44ff1af2", :move=>"Nuzzle", :target=>["Misty", 0]}, {:action=>"recall", :pokemon=>0, :target=>"06b2163b-404b-4985-bcee-0caab608783b"}, ...]
